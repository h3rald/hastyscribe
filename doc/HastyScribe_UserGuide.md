...
The easiest way to get {{hs}} is by downloading one of the prebuilt binaries from the [Github Release Page][release]:
  ...
  * [HastyScribe for Mac OS X (x86)]({{release}}/hastyscribe_v1.0.7_macosx_x86.zip) -- Compiled on OS X Mavericks (LLVM CLANG 6.0)
  * [HastyScribe for Windows (x86)]({{release}}/hastyscribe_v1.0.7_windows_x86.zip) -- Cross-compiled on OS X Mavericks (MinGW GCC 4.8.0)
  * [HastyScribe for Linux (x86)]({{release}}/hastyscribe_v1.0.7_linux_x86.zip) -- Cross-compiled on OS X Mavericks (GNU GCC 4.8.1)
  * [HastyScribe for Linux (ARM)]({{release}}/hastyscribe_v1.0.7_linux_arm.zip) -- Cross-compiled on OS X Mavericks (GNU GCC 4.8.2)
...
[release]:{{release -> https://github.com/h3rald/hastyscribe/releases/download/v1.0.7}}
